...
/// <summary>
/// Variation Order controller — inherits <see cref="PlatformApiController"/> for shared conventions, same
/// route/actor/exception-mapping pattern as every other module's controller.
/// </summary>
[Route("api/v1/construction/variation-orders")]
public sealed class VariationOrdersController : PlatformApiController
{
    private readonly VariationOrderService _service;

    public VariationOrdersController(VariationOrderService service) => _service = service;
    ...
    public async Task<IActionResult> List(CancellationToken cancellationToken)
    {
        ...
        return Ok(new PagedResult<VariationOrderDto>(items, totalCount, query.Skip, query.Top));
    }
    ...
    [HttpPost]
    public async Task<IActionResult> Create([FromBody] CreateVariationOrderRequest request, CancellationToken cancellationToken)
    {
