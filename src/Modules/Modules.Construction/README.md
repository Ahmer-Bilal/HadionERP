...
- **Subcontracts, Site Progress/Measurement, Variation Orders, Retention, IPC (Interim Payment
  Certificate)** — the roadmap's other named pieces of this module, and the reason this slice built
  Contract+BOQ first (everything else references a BOQ line or the Contract itself). Not started.
