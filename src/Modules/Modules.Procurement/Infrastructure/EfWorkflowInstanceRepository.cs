...
/// <see cref="ProcurementDbContext"/> — a near-duplicate of Modules.Finance's own copy, for the same "each
/// module owns its own schema" reason as <see cref="EfCoreNumberRangeService"/>.</summary>
public sealed class EfWorkflowInstanceRepository : IWorkflowInstanceRepository
{
    ...
    public EfWorkflowInstanceRepository(ProcurementDbContext dbContext)
    {
