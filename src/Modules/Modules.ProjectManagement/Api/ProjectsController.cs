...
namespace Modules.ProjectManagement.Api;

/// <summary>
/// Project controller — inherits <see cref="PlatformApiController"/> for shared conventions, same
/// route/actor/exception-mapping pattern as every other module's controller.
/// </summary>
[Route("api/v1/projectmanagement/projects")]
public sealed class ProjectsController : PlatformApiController
{
    ...
    public async Task<IActionResult> List(CancellationToken cancellationToken)
    {
        ...
        return Ok(new PagedResult<ProjectDto>(items, totalCount, query.Skip, query.Top));
    }
