...
/// error envelope), same route/actor/exception-mapping pattern as <see cref="CostCentersController"/>. Real authenticated identity ("CurrentActor" from Platform.Api.PlatformApiController) is the acting user;
