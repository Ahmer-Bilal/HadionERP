...
/// <summary>
/// Bank Account controller — inherits <see cref="PlatformApiController"/> for shared conventions, same
/// route/actor/exception-mapping pattern as <see cref="APInvoicesController"/>.
/// </summary>
[Route("api/v1/finance/bank-accounts")]
public sealed class BankAccountsController : PlatformApiController
{
    ...
    public async Task<IActionResult> List(CancellationToken cancellationToken)
    {
        ...
        return Ok(new PagedResult<BankAccountDto>(items, totalCount, query.Skip, query.Top));
    }

    [HttpGet("{id:guid}")]
    public async Task<IActionResult> Get(Guid id, CancellationToken cancellationToken)
    {
        var bankAccount = await _service.GetAsync(id, cancellationToken);
    ...
    {
        try { return Ok(await _service.UpdateAsync(id, request, CurrentActor, cancellationToken)); }
