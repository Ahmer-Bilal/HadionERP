...
/// a Platform.Core.Events.IDomainEvent, which stays strictly in-process (docs/architecture/04-platform-services.md
...
/// (e.g. "Procurement.PurchaseOrderApproved.v1") — see docs/architecture/04-platform-services.md #3 and
