...
/// (e.g. "PurchaseOrder.Submit triggers workflow PO_Approval_v3", docs/architecture/04-platform-services.md
/// #4). This is configuration data, not code — a functional consultant maintains these through the
/// eventual admin UI (docs/architecture/05-data-and-api.md #3), not a release.
/// </summary>
