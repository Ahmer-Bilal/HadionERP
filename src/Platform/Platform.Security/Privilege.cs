...
/// the naming convention "{Module}.{BO}.{Action}" in docs/architecture/06-engineering-standards.md #2.
/// Privileges are declared once by the module that owns the action they gate; they are bundled into
/// Duties, which are bundled into Roles (docs/architecture/04-platform-services.md #2.2) — an
