...
/// Modules.MasterData.Tests's own copy of this fake. The real implementation
/// (<c>Modules.Finance.Infrastructure.EfWorkflowInstanceRepository</c>) is proved separately by an
