...
/// Modules.Finance.Tests's own copy of this fake. The real implementation
/// (<c>Modules.Procurement.Infrastructure.EfWorkflowInstanceRepository</c>) is proved separately by an
