...
| ADR-6 | Workflow engine | **Elsa Workflows (.NET)** wrapped by an in-house Workflow Service | Avoid building a BPMN engine from scratch; keep swappable behind our own interface |
